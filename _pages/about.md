...
Hello, my name is Ke Li (李可). I am currently a PhD student in Decision Sciences at INSEAD, advised by [Spyros Zoumpoulis](https://www.insead.edu/faculty/spyros-zoumpoulis) (co-advisor: [Georgina Hall](https://www.insead.edu/faculty/georgina-hall)). 
...
- In one stream, I focus on **data-driven machine learning algorithms** that integrate optimization, estimation, and prediction to support robust decision-making under uncertainty.
